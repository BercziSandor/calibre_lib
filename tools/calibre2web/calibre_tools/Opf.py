...
from calibre2web.calibre_tools import Library
...
class Opf:
    ...
    def get_md_details(self):
        ...
        if len(self.covers) > 0:
            ...
            cover_link = f'<center><img src="{cover_url}" alt="cover" ' \
                         f'width="300"/></center>'
        ...
        if len(self.subjects) > 0:
            md_details += "## Tagek\n"
            # file:///C:/Entwicklung/work/Calibre/libs/main/_details/Allan%20Pease.html
            # https://github.com/berczisandor/calibre_lib/blob/main/main/_tags/kommunik%c3%a1ci%c3%b3.html
            # ../_tags/kommunik%c3%a1ci%c3%b3.html
